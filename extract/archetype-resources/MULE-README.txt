...
-----------------------------------------------------------------
./src/test/java/me/neilpiper/muledemo/MuledemoTestCase.java
...
artifactId=muledemo
description=muledemo
muleVersion=3.8.1
packagePath=com/mycompany/mule
forgeProject=n
transports=jms,jdbc,http,https,file,vm
modules=json,xml,boot,cxf,jersey,management,client,scripting,sxc

version=1.0-SNAPSHOT
groupId=me.neilpiper
basedir=/Users/neilpiper/SANDBOX/PROJECTS/HSBC/mule-projects
--------------------------------------------------------------------